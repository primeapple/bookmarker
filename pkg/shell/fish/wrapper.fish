...
complete -c bm --condition "not __fish_seen_subcommand_from $options" --require-parameter --arguments "(bm --list | awk '{ print \$2 }')" --description "Change directory to bookmark path"
complete -c bm --old-option a --long-option add --description "Add named bookmark to current directory"
complete -c bm --old-option g --long-option get --require-parameter --arguments "(bm --list | awk '{ print \$2 }')" --description "Print path to bookmark"
